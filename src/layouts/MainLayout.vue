  ...
  <q-layout view="lHh Lpr lFf">
    ...
    >
      <q-list>
        ...
        <q-item to="/" active-class="q-item-no-link-highlighting" exact>
        ...
        <q-item to="/Dashboard2" active-class="q-item-no-link-highlighting" exact>
          <q-item-section avatar>
            <q-icon name="dashboard"/>
          </q-item-section>
          <q-item-section>
        ...
        <q-item to="/Countries" active-class="q-item-no-link-highlighting" exact>
          <q-item-section avatar>
            <q-icon name="dashboard"/>
          </q-item-section>
          <q-item-section>
        ...
        <q-item to="/Cities" active-class="q-item-no-link-highlighting" exact>
          <q-item-section avatar>
            <q-icon name="dashboard"/>
          </q-item-section>
          <q-item-section>
            <q-item-label>Cities</q-item-label>
          </q-item-section>
        </q-item>

        <q-item to="/Addresses" active-class="q-item-no-link-highlighting" exact>
          <q-item-section avatar>
            <q-icon name="dashboard"/>
          </q-item-section>
          <q-item-section>
        ...
        <q-item to="/PropertyCategories" active-class="q-item-no-link-highlighting" exact>
          <q-item-section avatar>
            <q-icon name="card_giftcard"/>
          </q-item-section>
          <q-item-section>
            <q-item-label>Property Categories</q-item-label>
          </q-item-section>
        </q-item>
        <q-item to="/Properties" active-class="q-item-no-link-highlighting" exact>
          <q-item-section avatar>
            <q-icon name="card_giftcard"/>
          </q-item-section>
          <q-item-section>
        ...
        <q-item to="/CarCategories" active-class="q-item-no-link-highlighting" exact>
          <q-item-section avatar>
            <q-icon name="card_giftcard"/>
          </q-item-section>
          <q-item-section>
            <q-item-label>Car Categories</q-item-label>
          </q-item-section>
        </q-item>
        <q-item to="/Cars" active-class="q-item-no-link-highlighting" exact>
          <q-item-section avatar>
            <q-icon name="card_giftcard"/>
          </q-item-section>
          <q-item-section>
        ...
        <q-item to="/Users" active-class="q-item-no-link-highlighting" exact>
          <q-item-section avatar>
            <q-icon name="card_giftcard"/>
          </q-item-section>
          <q-item-section>
        ...
        <q-item to="/Roles" active-class="q-item-no-link-highlighting" exact>
          <q-item-section avatar>
            <q-icon name="card_giftcard"/>
          </q-item-section>
          <q-item-section>
